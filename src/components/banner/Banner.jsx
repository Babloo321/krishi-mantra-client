...
const Banner = () => {
  ...
  return (
    <div className="w-full overflow-x-hidden md:h-auto">
      <div className="slider-container w-full px-4 sm:px-6 lg:px-12 md:py-8">
          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="banner_text w-full md:w-1/2 px-2 md:px-6 h-auto md:min-h-[300px]">
                ...
                <button className="max-w-[171px] w-full flex items-center justify-center text-white gap-2 h-[48px] sm:h-[52px] bg-violet-900 cursor-pointer rounded-lg capitalize">
                  Shop Now <MoveRight />
                </button>
              </div>

              {/* Image Section */}
              <div className="banner_image relative w-full md:w-1/2 flex justify-center items-center px-2 sm:px-4 md:px-6 h-26 md:min-h-[300px]">
                <img
                  src={product?.image}
                  alt={product?.name}
