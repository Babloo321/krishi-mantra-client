...
const Footer = () => {
    return (
        <footer>
            <div className="hidden md:block footer_top mx-h-[343px] w-full border-t border-b border-[#e1e3e5] pt-[80px] pb-[60px]">
                    ...
                    <div className="grid grid-cols-4">
                        ...
                        <div>
                            ...
                            <div className="logo_wrapper mb-7">
                                <Link to='/' className="text-3xl text-black font-inter font-medium capitalize flex items-center gap-2"><Armchair size='2rem' color="#029fae" /> Krishi-Mantr</Link>
                            </div>
                        ...
                        <div className="footer_wrapper">
                            ...
                            <ul className="space-y-2 mt-4">
                                <li><Link className="text-base text-[#272343] font-inter font-normal capitalize">all</Link></li>
                                <li><Link className="text-base text-[#272343] font-inter font-normal capitalize">seeds</Link></li>
                                <li><Link className="text-base text-[#272343] font-inter font-normal capitalize">fertilizers</Link></li>
                                <li><Link className="text-base text-[#272343] font-inter font-normal capitalize">new products</Link></li>
            ...
            <div className=" hidden footer_bottom w-full h-[75px] md:flex items-center justify-center ">
                <div className="lg:container mx-auto">
                    <div className="flex items-center justify-between">
                        <div>
                           <p className="text-base text-[#9a9caa] font-normal font-inter">@ 2025 Designed & Develop <span className="text-[#272343]">Babloo-kumar</span></p> 
                        </div>
